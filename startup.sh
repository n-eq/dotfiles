...
packages=("git" "sudo" "ssh" "texlive" "gcc" "curl" "libcurl3" "python" "python-pip" "ruby" "libfribidi0" "libfribidi-dev" "nodejs" "npm" "pkg-configure" "dh-autoreconf" "gimp" "mplayer" "zathura")
counter=0
