...
"
"   Pressing "F2" in normal mode or in insert mode) will cause the
...
"
" This is the most interesting part: insert inner closing \begin{environment}
" when pressing F2 in both normal and insert mode
"
if !hasmapto("TexClosePrev()")
    nnoremap <buffer> <silent> <F2> :call TexClosePrev(0)<CR><esc>O
    inoremap <buffer> <silent>	<F2> 	<esc>:call TexClosePrev(1) <CR><esc>O
endif
